...
from solvers             import pcg, damped_jacobi
from utils               import  array_to_vect_stencil
...
# ========== Correction ==========================
xc_p = P.dot(xc)
#xc_p = comm.allreduce(xc_p, op=MPI.SUM )
...
# ========== Post Smoothing =======================
wt_pos = MPI.Wtime()
xf_2, info_pos = pcg(Af, pc, bf, x0=xf, tol=1e-6, maxiter=10, verbose=False)
...
for i in range(comm.Get_size()):
    if rank == i:
        ...
        print('Assembler time: {}'.format(wt_ass))
